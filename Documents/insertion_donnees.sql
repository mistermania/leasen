...
VALUES (1,'Velo','velo tout terrain 3 plateaux 7 vitesses',TRUE, 50, TRUE, 20 , TRUE , 1 ,1);
INSERT INTO objet (id_objet,nom_objet,description_objet,a_une_caution,prix_caution,est_payant,prix,o_est_affiche,id_utilisateur,id_type) 
VALUES (2,'Playstation 4','PS4 + fifa2017',TRUE, 50, TRUE, 10 , TRUE , 1 ,2);
INSERT INTO objet (id_objet,nom_objet,description_objet,a_une_caution,prix_caution,est_payant,prix,o_est_affiche,id_utilisateur,id_type) 
VALUES (3,'Appareil a raclette','Pour 8 personnes ',TRUE, 20, TRUE, 15 , TRUE , 1 ,4);
INSERT INTO objet (id_objet,nom_objet,description_objet,a_une_caution,prix_caution,est_payant,prix,o_est_affiche,id_utilisateur,id_type) 
VALUES (4,'Perceuse','Perceuse filaire avec foret',TRUE, 40, TRUE, 10 , TRUE , 1 ,5);
INSERT INTO objet (id_objet,nom_objet,description_objet,a_une_caution,prix_caution,est_payant,prix,o_est_affiche,id_utilisateur,id_type) 
VALUES (5,'Appareil a pierrade','Pour 6 personnes ',TRUE, 40, TRUE, 5 , TRUE , 1 ,4);
