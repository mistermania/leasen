...
function affichageprincipale($connexion)
{
    if ($connexion == 1) {
        ...
        <div class="cyan darken-4">
            ...
            <div class="row">
                <div class="col s3 ">
                    <div class="white  blue-grey-text  text-darken-4">
                        ...
                        <br>
                        <a class="col s8 offset-s2 waves-effect waves-light amber darken-2 btn">En savoir plus<i
                ...
                <div class="col s3">
                    <div class="white  blue-grey-text  text-darken-4">
                        ...
                        <h6 class="center-align"> Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            ...
                            Quisque nec ante auctor, hendrerit ex ac, placerat risus. </h6>
                        <br>
                        <a class="col s8 offset-s2 waves-effect waves-light col  amber darken-2 btn">En savoir plus<i
                                    class="material-icons right">info</i></a>
                        <br>
                        <br>
                        <br>
            ...
            <div class="row">
                <div class="col s4 offset-s4">
                    <a class="waves-effect waves-light white blue-grey-text text-darken-4 btn">Explorer toutes les
